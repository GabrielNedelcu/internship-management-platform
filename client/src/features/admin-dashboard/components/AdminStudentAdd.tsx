      ...
      <Row gutter={[16, 16]}>
        <Col span={12}>
          ...
          <Form layout="vertical" size="large">
            <Form.Item>
              <Input placeholder="Type in the student's full name" />
            </Form.Item>
            <Form.Item>
              <Input placeholder="Type in the student's email" />
            </Form.Item>
            <Form.Item>
              <Input placeholder="Type in the student's group" />
            </Form.Item>
            <Form.Item>
              <Input placeholder="Type in the student's CNP" />
            </Form.Item>
            <Form.Item>
              <Input placeholder="Type in the student's passport" />
            </Form.Item>
            <Form.Item>
